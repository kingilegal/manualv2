...
class GuardiansControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create guardian" do
    assert_difference('Guardian.count') do
      post guardians_url, params: { guardian: { email: @guardian.email, name: @guardian.name, phone: @guardian.phone, student_id: @guardian.student_id } }
    end
  ...
  test "should update guardian" do
    patch guardian_url(@guardian), params: { guardian: { email: @guardian.email, name: @guardian.name, phone: @guardian.phone, student_id: @guardian.student_id } }
