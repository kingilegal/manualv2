...
class InstitutesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create institute" do
    assert_difference('Institute.count') do
      post institutes_url, params: { institute: { address: @institute.address, contact: @institute.contact, district_id: @institute.district_id, email: @institute.email, name: @institute.name, phone: @institute.phone } }
    end
  ...
  test "should update institute" do
    patch institute_url(@institute), params: { institute: { address: @institute.address, contact: @institute.contact, district_id: @institute.district_id, email: @institute.email, name: @institute.name, phone: @institute.phone } }
