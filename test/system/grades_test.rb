...
class GradesTest < ApplicationSystemTestCase
  ...
  test "creating a Grade" do
    ...
    fill_in "Daytime", with: @grade.daytime
    fill_in "Director", with: @grade.director
    fill_in "Institute", with: @grade.institute_id
    fill_in "Name", with: @grade.name
    fill_in "Number Student", with: @grade.number_student
